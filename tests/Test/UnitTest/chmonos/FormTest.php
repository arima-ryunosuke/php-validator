        ...
        // context
        {
            ...
            that($form)->input('child1')->htmlMatchesArray([
                'input' => [
                    ...
                    'data-vinput-parent'    => 'children/1',
                    'data-vinput-class'     => 'children/child1',
                    'data-vinput-index'     => '1',
                    'data-vinput-name'      => 'child1',
        ...
        // template
        {
            ...
            that($form)->input('child1')->htmlMatchesArray([
                'input' => [
                    ...
                    'data-vinput-parent'    => 'children/__index',
                    'data-vinput-class'     => 'children/child1',
